...
public class Vehiculo {
	...
	public Vehiculo(String placa, String tjeta_prioridad, String cilindrada, String color, String num_motor,
			...
			Integer idben, List<CombustibleVehiculo> combustibleVehiculo, TipoVehiculo tipoVehiculo,
			MarcaVehiculo marcaVehiculo, TipoServicioVehiculo tipoServicio, TipoMotorVehiculo tipoMotor,
			ModeloVehiculo modeloVehiculo, Persona persona) {
		super();
		this.placa = placa;
	...
	public String toString() {
		return "Vehiculo [placa=" + placa + ", tjeta_prioridad=" + tjeta_prioridad + ", cilindrada=" + cilindrada
				...
				+ idmodv + ", idben=" + idben + ", combustibleVehiculo=" + combustibleVehiculo + ", tipoVehiculo="
				+ tipoVehiculo + ", marcaVehiculo=" + marcaVehiculo + ", tipoServicio=" + tipoServicio + ", tipoMotor="
				+ tipoMotor + ", modeloVehiculo=" + modeloVehiculo + ", persona=" + persona + "]";
	}
